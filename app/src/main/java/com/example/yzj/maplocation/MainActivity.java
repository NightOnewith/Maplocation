package com.example.yzj.maplocation;
...
//        option.setWifiValidTime(5*60*1000);
    ...
    public class MyLocationListener extends BDAbstractLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            if (location.getLocType() == BDLocation.TypeGpsLocation){
                ...
                Toast.makeText(getApplicationContext(), location.getLocationDescribe(), Toast.LENGTH_LONG).show();
            ...
            Log.i("BaiduMapResult","定位时间:"+location.getTime()+"\n定位唯一ID:"+location.getLocationID()+"\n定位类型:"+location.getLocType()
                    ...
                    +"\n当前位置:"+location.getLocationDescribe() +"\n周边POI:"+location.getPoiList());
        }
    ...
    private void drawMark(double varX, double varY) {
        ...
        BitmapDescriptor bitmap = BitmapDescriptorFactory.fromResource(R.drawable.location); // 描述图片
    ...
    private void drawCircle( double varX, double varY) {
        ...
        circleOptions.center(new LatLng(varX, varY))//中心
                ...
                .stroke(new Stroke(5, 0x60FF0000));  //边框的宽度和颜色
        //把绘制的圆添加到百度地图上去
